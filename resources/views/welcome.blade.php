...
@endsection
@section('content')
<div class="font-sans bg-gray-100 flex flex-col min-h-screen">

    <!-- Home Section -->
    <section id="home" class="relative h-screen bg-cover bg-center items-center" style="background-image: url('images/home-bg.png');">
        <!-- Navbar -->
        <header class="sticky top z-index-50 top-0 left-0 right-0 bg-gray-800 bg-opacity-20 z-50">
            <div class="container mx-auto flex justify-between items-center py-4">
                ...
                <div class="space-x-4">
                    ...
                    <a href="{{ route("login") }}" class="bg-white text-gray-800 px-4 py-2 rounded-full">Login</a>
                </div>
            </div>
        </header>
